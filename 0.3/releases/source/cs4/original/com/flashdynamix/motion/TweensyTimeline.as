...
package com.flashdynamix.motion {
	...
	public class TweensyTimeline {
		 ...
		 * 
		 * @param instance The instance Object to be tweened or multiple instances if using the type Array e.g. <code>timeline.to([item1, item2], {x:50, y:50});</code>
		 ...
		 * 
		 * @param instance The instance Object to be tweened or multiple instances if using the type Array e.g. <code>timeline.from([item1, item2], {x:50, y:50})</code>;
		 ...
		 * 
		 * @param instance The instance Object to be tweened or multiple instances if using the type Array e.g. <code>timeline.fromTo([item1, item2], {x:50, y:50});</code>
		 * @param from An Object containing the properties you would like to tween from e.g. <code>{x:50, y:25}</code>
		 * or this can be relative e.g. {x:'50', y:'-25'} or can be a random position e.g. <code>{x:'-50, 50', y:'-25, 25'}</code>
		 * @param to An Object containing the properties you would like to tween to e.g. <code>{x:50, y:25}</code>
		 * or this can be relative e.g. {x:'50', y:'-25'} or can be a random position e.g. <code>{x:'-50, 50', y:'-25, 25'}</code>
		...
		public function updateTo(instance : Object, to : Object) : void {
			...
			for each(tween in list) {
				if(tween.key == instance) tween.updateTo(position, to);
			}
		}
		 ...
		 * <li><code>timeline.stop([instance1, instance2]);</code> - stops all property tweens for these instances.</li>
		 * <li><code>timeline.stop([instance1, instance2], "x", "y");</code> - stops all x,y property tweens for these instances.</li>
		...
		public function stop(instance : * = null, ...props : Array) : void {
			var instances : Array = (instance is Array) ? instance : (instance == null) ? null : [instance];
			var tween : AbstractTween;
			var i : int;
			...
			for (i = _tweens - 1;i >= 0; i--) {
				...
				if(instances == null || instances.indexOf(tween.key) != -1) {
		...
		public function add(instance : Object, update : Object = null) : AbstractTween {
		...
		public function dispose() : void {
			...
			var tween : AbstractTween;
			for each(tween in list) tween.dispose();
